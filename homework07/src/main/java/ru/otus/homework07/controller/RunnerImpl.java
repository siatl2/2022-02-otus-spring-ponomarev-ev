package ru.otus.homework07.controller;
...
import ru.otus.homework07.service.CommentCrud;
import ru.otus.homework07.service.GenreCrud;
...
public class RunnerImpl {
    ...
    @ShellMethod("Read All Comments By BookId")
